...
export function FeatureCard({
  ...
  return (
    <div className={cn("relative group pt-14", className)}>
      ...
      {/* Main Card */}
      <div className="relative w-full h-full bg-gradient-to-br from-[#3a4b7c] via-[#2d3d6b] to-[#24335c] rounded-[32px] px-8 pt-16 pb-10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-10 border border-white/10 flex flex-col items-center text-center overflow-hidden transition-all duration-500 group-hover:-translate-y-2 group-hover:shadow-[0_30px_60px_rgba(0,0,0,0.6)]">
        ...
        {/* Circle Icon - Elevated with Ring */}
